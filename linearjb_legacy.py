...
if __name__ == "__main__":
    ...
    turn_level_attacks = turn_level_attacks,
)
    ...
    with open(f"{out_dir}/linear_jb_2results.json", "w") as f:
        json.dump(records, f, indent=2)
    with open(f"{out_dir}/linear_jb_2results.txt", "w") as f:
        for r in records:
